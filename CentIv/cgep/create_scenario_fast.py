...
import ext2int
import change_timeperiod_resolution
from save_results import SaveResults
import save_results as save_results_fcns
import time
import logging
...
class DataImport(object):
    ...
    def GetOptimization(self, config: Config):
        ...
        res_change = change_timeperiod_resolution.ChangeResolution(config.timeperiods, config.tpResolution)
        ...
        if config.duals_required:
            ...
            save_results_fcns.saveVarParDualsCsv(opt.model, results_folder)
        ...
        save_results_fcns.saveSelectedStats(opt, duration_log_dict, results_folder)
