...
class ConventionalGeneratorsCHInvestBinary:
    def __init__(self, state, gens, candidate_gens, existing_gens):
        ...
        self.generators,
        within=Binary) #binary variable to indicate whether a generator is built (1) or not (0)
    ...
    def get_gens_built(self):
        ...
        for g in self.model.CandGens:
            generators[g] = int(value(self.model.GenBuild[g]))
        return generators        