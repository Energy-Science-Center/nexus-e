...
class NuclearGeneratorsCHInvestCont:
    ...
    """
    def set_min_power_CH_nuclear(self, GENS, min_power, availability=None):
        ...
        if availability is None:
            ...
            self.model.AvailabilityNewNucl = Param(
                GENS,
                self.model.TimePeriods,
                within=NonNegativeReals,
            ...
            self.model.MinPowerConNuclearCH = Constraint(
                GENS,
                self.model.TimePeriods,
                rule=lambda m,g,t: m.PowerGenerated[g,t] >= m.MinPowerNuclearCH[g] * m.AvailabilityNewNucl[g, t] * self.model.GenBuildNuclear[g])
    ...
    def get_gens_built_nuclear(self):
        ...
        for g in self.model.CandNucGens:
            original_capacity = ValueFormatter(float(value(self.model.GenBuildNuclear[g])))
            generators[g] = (
                original_capacity
                .truncate(decimal=1)
                .round_up(decimal=0)
