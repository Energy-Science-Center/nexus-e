...
@dataclass
class Config:
    excel_file_path: str = "scenario_data/source_excel/input.xlsx"
    ...
    user: str = "root"
    password: str = "root"
    dump_file_path: str = "Shared/DBcreation/schema_structure/Dump_STRUC_clean_v9.sql"

    include_flex_params: bool = False
    demand_profiles_path: str = "scenario_data/source_excel/Nexuse_DB-Input_v47_TYNDP22-GA08_CentIvPV_base_DemandProfiles"

    include_tyndp24: bool = False
    tyndp24_data_path: str = "scenario_data/TYNDP24_datasets/TYNDP24_nbc"
