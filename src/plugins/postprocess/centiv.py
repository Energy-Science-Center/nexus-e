...
from .legacy import demand as postprocess_demand
from .legacy import ElectricityPrice as postprocess_electricity_price
from .legacy import emissions as postprocess_emissions
from .legacy import Generation as postprocess_generation
from .legacy import power_flow_map as postprocess_power_flow_map
from .legacy import revenue_profit as postprocess_revenue_profit
from .legacy import Storage as postprocess_storage
from .legacy import system_costs as postprocess_system_costs
